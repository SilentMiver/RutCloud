...
import com.example.rutcloud.config.StorageProperties;
import com.example.rutcloud.config.exceptions.StorageException;
...
public class StorageServiceImpl implements StorageService {
    ...
    public void delete(MultipartFile file) throws IOException {
        deleteFileByName(file.getOriginalFilename());
    }
